...
class Dragon extends Character{
    ...
    burnCharacter(Adventurer){

        console.log(`${Dragon.name} used his fire attack on ${Adventurer.name}`);
        for(let i = Adventurer.health; i >= 0; i= i - 20){
            Adventurer.health = i;
            console.log(`The adventurer ${Adventurer.name} has a health of ${Adventurer.health} `)
        }
       if(Adventurer.health == 0) {
        console.log(`${Adventurer.name} is now dead`);
       }
...
const Seasmoke = new Dragon("SeaSmoke");
Seasmoke.burnCharacter(robin);
